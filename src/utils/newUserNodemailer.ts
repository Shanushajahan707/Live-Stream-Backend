    ...
    const mailOptions = {
      ...
      html: `
          <div style="font-family: Arial, sans-serif;">
            ...
            <a href="https://capture-live.vercel.app/otp-verification" style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: #fff; text-decoration: none; border-radius: 5px;">Verify Account</a>
